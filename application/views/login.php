  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <!-- <h1 style="text-align: center; color: #2C3E50;">LenDexSys</h1> -->
         <div class="text-center login_logo">
        <a href="http://lendexsys.com/"><img src="<?php echo site_url('assets/images/logosmall.png');?>"></a>
    </div>
