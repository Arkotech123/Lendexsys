<section id="borowerb">
	<div class="container borowerformbg">
		...
		<div class="row">
			<div class="col-md-12 col-lg-12 col-sm-12 text-center defaultimg bluetext">
				<img src="<?php echo site_url('assets/images/OOPS.png');?>">
				<h2>OOPS! <?php echo $this->session->userdata['user_name']; ?> You Have Defaulted</h2>
			</div>
			
		</div>
		<div class="row">
			<div class="col-md-4 col-lg-3 col-sm-12"></div>
			<div class="col-md-4 col-lg-6 col-sm-12 text-center graytext">
				<h2>Lets get you back on track</h2>
				<div> <a class="btn btn-xl btnmakepay" href="http://lendexsys.com/register">Make A Payment</a></div>
